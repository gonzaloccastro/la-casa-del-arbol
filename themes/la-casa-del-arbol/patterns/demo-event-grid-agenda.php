 ...
 * Description: Contenido de demostración. Mosaico de la Agenda: 3 columnas, 2 en tablet y una columna en mobile; cada tarjeta respeta la proporción de su afiche. En cada tarjeta elegí el afiche, reemplazá los textos y enlazá el título. El sello circular va solo si la entrada es "Entrada libre" o "A la gorra"; si no, borralo.
 * Viewport Width: 1200
 * Inserter: yes
 *
...
<div class="wp-block-group alignwide lcda-event-grid lcda-event-grid--agenda"><!-- wp:group {"tagName":"article","className":"lcda-event-card lcda-event-card--full"} -->
